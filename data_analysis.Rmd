...
#Answer 1: We wanted to look at whether workers in ctities without the tip credit make more than those in cities that pay sub-minimum wage, so we looked at two occupations heavily dependent on tips: bartenders and servers. Our initial investigation found that the answer to the question is NO. D.C. instituted a tip credit in 2018, and since then, their median wages, according to the data gathered from the Bureau of Labor Statistics Occupational Employment and Wage Statistics, have been higher than the wages in Seattle and San Francisco, the two non-tip-credit locales. This trend seemed to flatten a bit in 2021, but that was the during the pandemic, so it's hard to tell if employers were using loans to pay their employees even though restaurants suffered during covid. It could also be that less people were eating out in D.C. than in Seattle and San Fran, further impacting tips and wages. In other words, there are a lot of factors as to why the median income for the two professions in D.C. fell below that of Seattle and San Fran in 2021. We decided to use a grouped bar graph because it allowed us to compare the median incomes of the three cities for the past 11 years. The graphs created in datawrapper are included below, along with the code generated for this investigation.
